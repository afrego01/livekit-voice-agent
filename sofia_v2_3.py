...
async def end_call(context: RunContext) -> str:
    """Termina la llamada de forma natural cuando la conversación ha concluido.
    Úsala solo después de haberte despedido del cliente.
    """
...
_RECEPCION_HANDOFF_TOOL_NAMES = frozenset(
    {"handoff_to_AgenteProspecto", "handoff_to_AgenteSoporte", "transferencia_llamada"}
)


def _tool_name_is_recepcion_handoff(name: str | None) -> bool:
    """True si el tool call corresponde a un handoff o transferencia del recepcionista.
