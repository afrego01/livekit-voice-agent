    ...
    def __init__(self, *, identificado_por_sip: bool = False) -> None:
        ...
        super().__init__(
            instructions=(
                ...
                2.3. IF se encuentra información del cliente, preguntarle al cliente que información desea saber de su cuenta y proporcionarle información de manera conversacional y clara al cliente.
...
async def entrypoint(ctx: JobContext):
    ...
    try:
        await ctx.wait_for_participant(timeout=5.0)
