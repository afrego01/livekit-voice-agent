    ...
    def __init__(self, *, identificado_por_sip: bool = False) -> None:
        ...
        super().__init__(
            instructions=(
                ...
                4. IF la intención del cliente es reportar alguna falla, lentitud, desconexiones, problemas con equipo, O pregunta por su servicio activo, paquete contratado, velocidad de su plan, estado de cuenta, pagos, facturación, tickets o cualquier detalle de su contrato actual (EXCEPTO los casos del paso 5):
